...
namespace MethodLevel2
{
    ...
    class UnitConverterDemo3
    {
        public void InputMethod()
        {
            ...
            Console.WriteLine($"{fahrenheit} Fahrenheit is {UnitConverter.ConvertFahrenheitToCelsius(fahrenheit)} Celsius.");

            // Celsius to Fahrenheit
            Console.Write("Enter Celsius to convert to Fahrenheit: ");
            double celsius = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine($"{celsius} Celsius is {UnitConverter.ConvertCelsiusToFahrenheit(celsius)} Fahrenheit.");
